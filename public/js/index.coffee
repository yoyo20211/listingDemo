    ...
    # },
    rpc = new easyXDM.Rpc({
        remote: "http://localhost:7575/js/easyXDM/cors/index.html",
        remoteHelper: "http://localhost:7575/js/easyXDM/name.html",
        swf: "http://localhost:7575/js/easyXDM/easyxdm.swf",
        local: "http://localhost:7575/js/easyXDM/name.html"
    },
    {
        remote: { request: {} }
    })
