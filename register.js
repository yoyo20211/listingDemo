...
(function() {
  var CityInfo, CountryInfo, HALF_AN_HOUR, LoginToken, PostItem, Process, RegionInfo, SOCKET_IO_CHANNELS, Settings, Thoonk, UniqueLocation, UploadPhoto, UploadVideo, UploadVoice, User, WishList, abortedFlag, app, capitalize, certificate, channel, channels, checkupload, createSocketIOChannel, cronJob, db, express, fieldsJob, formidable, fs, generateResponse, generateUniqueId, iced, io, isMobilePhone, job, key, kybos, loadUser, loadUserAjax, logger, mailer, mainPort, mkdirs, nib, path, photoJob, postingJob, postingSystem, random, savefields, service, sessionStore, settings, socketIOMainChannel, socketIOPort, stylus, thoonk, tmp, transformToLocationString, url, videoJob, voiceJob, _, __iced_deferrals, __iced_k, __iced_k_noop,
    _this = this;
  ...
  app.post("/api/register/", function(req, res) {
    var city, cityAndState, country, email, latitude, longitude, neighborhood, password, state, user, username, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
    username = req != null ? (_ref = req.body) != null ? _ref.username : void 0 : void 0;
    email = req != null ? (_ref2 = req.body) != null ? _ref2.email : void 0 : void 0;
    password = req != null ? (_ref3 = req.body) != null ? _ref3.password : void 0 : void 0;
    city = req != null ? (_ref4 = req.body) != null ? _ref4.city : void 0 : void 0;
    state = city;
    country = req != null ? (_ref5 = req.body) != null ? _ref5.country : void 0 : void 0;
    neighborhood = req != null ? (_ref6 = req.body) != null ? _ref6.neighborhood : void 0 : void 0;
    latitude = req != null ? (_ref7 = req.body) != null ? _ref7.latitude : void 0 : void 0;
    longitude = req != null ? (_ref8 = req.body) != null ? _ref8.longitude : void 0 : void 0;
  ...
  app.post("/api/login/", function(req, res) {
    var email, password, rememberMe, _ref, _ref2, _ref3;
    email = req != null ? (_ref = req.body) != null ? _ref.email : void 0 : void 0;
    password = req != null ? (_ref2 = req.body) != null ? _ref2.password : void 0 : void 0;
    rememberMe = (req != null ? (_ref3 = req.body) != null ? _ref3.remember_me : void 0 : void 0) === "true" ? true : false;
    console.log(email);
    ...
    if ((email != null) !== "" && (password != null) !== "" && typeof email !== "undefined" && typeof password !== "undefined") {
      return User.findOne({
        ...
        var address, loginToken, session, _ref4, _ref5, _ref6, _ref7, _ref8;
        if (err) console.log(err);
        if (user) {
          console.log("user lat " + (user != null ? (_ref4 = user.location) != null ? _ref4["0"] : void 0 : void 0));
          if (user && user.authenticate(password)) {
            ...
            if (rememberMe) {
              loginToken = new LoginToken({
                ...
                location: [parseFloat(user != null ? (_ref5 = user.location) != null ? _ref5["0"] : void 0 : void 0), parseFloat(user != null ? (_ref6 = user.location) != null ? _ref6["1"] : void 0 : void 0)]
              });
              ...
              loginToken = new LoginToken({
                ...
                location: [parseFloat(user != null ? (_ref7 = user.location) != null ? _ref7["0"] : void 0 : void 0), parseFloat(user != null ? (_ref8 = user.location) != null ? _ref8["1"] : void 0 : void 0)]
              });
              return loginToken.save(function(err, token) {
                if (err) console.log(err);
                if (token) {
  ...
  app.get("/", function(req, res) {
    ...
    (function(__iced_k) {
      ...
      if (isMobilePhone(ua)) {
        ...
        token = req != null ? (_ref2 = req.cookies) != null ? _ref2.logintoken : void 0 : void 0;
        (function(__iced_k) {
          if (token) {
              ...
              (function(__iced_k) {
                ...
                if (token$) {
                  ...
                  loginToken = new LoginToken({
                    ...
                    rememberme: true,
                    address: {
                      city: token$ != null ? (_ref3 = token$.address) != null ? _ref3.city : void 0 : void 0,
                      state: token$ != null ? (_ref4 = token$.address) != null ? _ref4.state : void 0 : void 0,
                      country: token$ != null ? (_ref5 = token$.address) != null ? _ref5.country : void 0 : void 0,
                      neighborhood: token$ != null ? (_ref6 = token$.address) != null ? _ref6.neighborhood : void 0 : void 0
                    },
                    location: [parseFloat(token$ != null ? (_ref7 = token$.location) != null ? _ref7["0"] : void 0 : void 0), parseFloat(token$ != null ? (_ref8 = token$.location) != null ? _ref8["1"] : void 0 : void 0)]
                  });
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
  ...
  app.get("/api/alluserinfo/:username/", function(req, res) {
    ...
    (function(__iced_k) {
      ...
      if (error) {
        ...
        if (postitems) {
          for (_j = 0, _len2 = postitems.length; _j < _len2; _j++) {
  ...
  app.post("/api/postitem/:processId/", function(req, res) {
    ...
    form.on("aborted", function() {
      ...
      var err, file, item, message, postitem_temp, user, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _j, _len, _len2,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (!abortedFlag[processId]) {
        ...
        if (overSizeFile.length > 0) {
          message = "";
          for (_j = 0, _len2 = overSizeFile.length; _j < _len2; _j++) {
  ...
  app.post("/api/editpostitem/:processId/", function(req, res) {
        ...
        if (!abortedFlag[processId] && postitem) {
          ...
          (function(__iced_k) {
            if (item.fields.fileType === "photo") {
              ...
              (function(__iced_k) {
                if (item.fields.fileType === "voice") {
                  if (item.processType === "delete") item.files.voiceFile = "none";
