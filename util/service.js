...
(function() {
  var CityInfo, CountryInfo, LocationInfo, LoginToken, Mailer, Photo, PostItem, RatingComment, RatingCommentTopic, RegionInfo, Settings, UniqueLocation, User, WishList, ZipInfo, authFromLoginToken, authFromLoginTokenAjax, capitalizeFirstLetters, db, emitter, events, fs, generateResponse, getAllDistinctLocationString, getAllValidEmailDomainNames, getCategories, getCategoriesWithTotal, getCities, getCitiesByZipcode, getCountries, getUserPostingTotal, iced, interpretError, isMobilePhone, loadUser, loadUserAjax, logger, mkdirs, models, mongoose, path, settings, transformToLocationString, trim, uniqueId, updateUniqueLocation, winston, _, __iced_k, __iced_k_noop;
  ...
  authFromLoginToken = function(req, res, next) {
    var cookie, _ref, _ref2;
    if (req != null ? (_ref = req.cookies) != null ? _ref.logintoken : void 0 : void 0) {
      cookie = JSON.parse(req != null ? (_ref2 = req.cookies) != null ? _ref2.logintoken : void 0 : void 0);
    }
